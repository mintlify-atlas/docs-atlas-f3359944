...
Learn more in the [Effect DevTools documentation](https://effect.website/docs/guides/devtools).
...
See the [Testing Guide](/advanced/testing) for details.
...
<CardGroup cols={2}>
  ...
  <Card title="Core Concepts" icon="book" href="/core/effect-type">
